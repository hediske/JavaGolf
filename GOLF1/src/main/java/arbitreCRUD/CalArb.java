...
public class CalArb extends javax.swing.JInternalFrame {   
    ...
    public CalArb(arbitre a,Connection con) {
        this.a=a;
        this.con=con;
        initComponents();
        remplir_tab();
    ...
    String sql;
    sql = ("Select nom_compt, date_compt ,nom_type from competition join type_compt on ( competition.id_type=type_compt.id_type) where Date_compt>=Curdate() and id_arbitre= '"+a.getId()+"'");
    ...
    try
    {
        while (rs.next())
            {
                ...
                String tbData[]={Competition,date1,Type};
        ...
        rs.close();
            ...
            JOptionPane.showMessageDialog(null,"Erreur dans la base de donnees "+ex);
            System.out.print(ex);
    }
    }
